...
export default function ResumeTemplate({ pretty }) {
  ...
  return (
    <article
      id="resume"
      className={`${styles.resume} ${utilStyles.paper}`}
      itemScope
    ...
    >
      ...
      <section className={`${styles.objective} ${styles.header}`}>
        ...
        <p>
          Product Design focused front-end developer currently creating
          user-centric experiences using Vue.js, JavaScript, and Node. I enjoy
          working in cross-functional teams with product managers and designers
          to create design systems which are accessible, modular, extensible,
          and engaging. Passionate about prototyping to push products to their
          maximum potential incorporating design principles and modern
          development practices. Driven to create memorable experiences for the
          user.
        </p>
      </section>
      ...
      <section className={styles.education}>
        ...
        <details open>
          <summary>
            <h4 className={styles.degree}>
              <span itemProp="degree">
                French Language{breakIfPretty}&amp; Literature
              </span>
              ,{breakIfPretty}
              <span itemProp="degree">American History</span>
            </h4>
            <span
              itemProp="alumniOf"
              itemScope
            ...
            >
              <h5 itemProp="name" className={styles.organization}>
        ...
        <details open>
          <summary>
            <h4 className={styles.degree}>Full-Stack Engineering</h4>
            <span
              itemProp="alumniOf"
              itemScope
              itemType="http://schema.org/EducationalOrganization"
          ...
          <p>
            Intensive, industry leading Full Stack bootcamp. Created an online
            application portal to help other students gain acess to scholarship
            opportunities. Specialties include:
          </p>
          <ul>
      ...
      <section className={`${styles.experience} ${styles.header}`}>
        <h3 className={`${styles["experience-title"]} ${styles.heading}`}>
          Experience
        </h3>
        ...
        <div className={styles["experience-list"]}>
          <details open>
            <summary>
              <h4 itemProp="jobTitle" className={styles["job-title"]}>
                Creative Technologist
              </h4>
              <span
                itemProp="worksFor"
                itemScope
                itemType="http://schema.org/Oragnization"
              >
                <h5 className={styles.organization} itemProp="name">
                  Wiley
                </h5>
              </span>
            ...
            <p itemProp="description">
              Led front-end digital transformation of flagship product,
              Everything DiSC® on Catalyst™. Catalyst.everythingdisc.com has
              helped people all over the world be more happy and productive at
              work. Co-led implementation of design system across digital
              products. Consulted on design system for Dummies.com. Created
              code-based reusable prototypes with an emphasis on user experience
              and accessibility.
              {!pretty &&
          ...
          <details open>
            <summary>
              <h4 className={styles["job-title"]} itemProp="jobTitle">
            ...
            <p itemProp="description">
              ...
              Helped lay foundation for SaaS platform to connect physicians with
              insurance agents.
              {!pretty &&
          ...
          <details open>
            ...
            <p itemProp="description">
              Developed product pages, advertising banners, and HTML emails to
              generate campaigns for clients such as Best Buy, Delta Airlines,
              and Three Rivers Parks to reach millions of users.
            </p>
            <h6>Technologies</h6>
            <ul className={pretty ? utilStyles.inlineList : undefined}>
              <li>Laravel</li>
        ...
        <address>
          ...
          <ul className="contact-list">
            <li className={styles["print-only"]}>
              {!pretty && <h6 className={styles.link}>tel</h6>}
              <span itemProp="telephone">
                <a href="tel:763-501-9532">(763) 501-9532</a>
              </span>
            </li>
            <li>
              <a
